...
function SimpleGeoClient(key,secret) {
  var consumer = oauth.createConsumer(this.key,this.secret);
  var signer = oauth.createHmac(consumer);
  
  return oauth.createClient(80,simplegeo.base);
}
...
SimpleGeoClient.prototype.addRecord = function(record, callback) {
  ...
  return this._request('PUT', url, record.encode(), callback);
};
...
SimpleGeoClient.prototype.addRecords = function(layer, records, callback) {
  ...
  return this._request('POST', url, body, callback);
};
...
SimpleGeoClient.prototype.deleteRecord = function(layer, id, callback) {
  ...
  return this._request('DELETE', url, null, callback);
};
...
SimpleGeoClient.prototype.getRecord = function(layer, id, callback) {
  ...
  return this._request('GET', url, null, callback);
};
...
SimpleGeoClient.prototype._request = function(method, path, body, callback) {
  ...
  var req = this.request(method, path, headers, null, signer);
  var data = '';
